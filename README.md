...
- Print sheet per event: QR code, event name and date on one A4 page, in the color of the organization
...
Current version: `0.45.1`. See [CHANGELOG.md](./CHANGELOG.md) for release notes.
