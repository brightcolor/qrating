...
ADMIN_APP_URL="${REQUESTED_ADMIN_APP_URL:-${REQUESTED_PUBLIC_APP_URL:-https://app.qrating.de}}"
...
set_env CORS_ALLOWED_ORIGINS "$(env_or_default CORS_ALLOWED_ORIGINS "${ADMIN_APP_URL},${FEEDBACK_APP_URL}")"
...
set_env FRONTEND_PORT "$(env_or_default FRONTEND_PORT 8080)"
set_env BACKEND_PORT "$(env_or_default BACKEND_PORT 127.0.0.1:4000)"
set_env TRUST_PROXY "$(env_or_default TRUST_PROXY 1)"
