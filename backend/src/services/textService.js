export const defaultTextsByLanguage = {
  de: {
    ...
    newsletter_question: 'Sollen wir dir Infos zu kommenden Events schicken?',
    newsletter_yes: 'Ja, gern',
    newsletter_no: 'Nein, danke',
    ...
    summary_newsletter_label: 'Event-Infos',
    ...
    newsletter_help: 'Wir schicken dir ausgewählte Infos zu kommenden Veranstaltungen.',
  ...
  en: {
    ...
    newsletter_question: 'Want updates about upcoming events?',
    newsletter_yes: 'Yes, please',
    newsletter_no: 'No, thanks',
    ...
    summary_newsletter_label: 'Event updates',
    ...
    newsletter_help: 'We send you selected updates about upcoming events.',
