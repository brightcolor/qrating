export const defaultTextsByLanguage = {
  de: {
    ...
    newsletter_offers_label: 'Und gern vorab: Vorverkaufsstarts vor allen anderen, Verlosungen und Abende, die es nicht ins offene Programm schaffen.',
    newsletter_offers_summary: 'Frühbucher, Verlosungen, Exklusives',
  ...
  en: {
    ...
    newsletter_offers_label: 'And first in line, please: presale starts ahead of everyone else, prize draws and nights that stay off the open programme.',
    newsletter_offers_summary: 'Early bird, draws, exclusives',
